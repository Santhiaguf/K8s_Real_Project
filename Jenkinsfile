pipeline {
    ...
    environment {
        ...
        EKS_CLUSTER_NAME = 'fgs_cluster' // Replace with your EKS cluster name
    ...
    stages {
        stage('SCM checkout') {
            steps {
                script {
                    git branch: 'main', credentialsId: 'git-cred', url: 'https://github.com/Santhiaguf/K8s_Real_Project.git'
                }
            }
        }
